...
export const zh = {
  ...
  settings: {
    ...
    uninstall: {
      title: '卸载 MindOS',
      desc: '从本机移除 MindOS CLI、后台服务和配置文件。',
      warning: '此操作将停止所有运行中的服务并移除 MindOS。你的知识库文件不会被删除，除非你主动选择。',
      stopServices: '停止服务',
      stopServicesDesc: '停止所有运行中的 MindOS 进程和后台守护进程。',
      removeConfig: '移除配置',
      removeConfigDesc: '删除 ~/.mindos/ 目录（配置、日志、PID 文件）。',
      removeNpm: '卸载 CLI 包',
      removeNpmDesc: '执行 npm uninstall -g @geminilight/mindos。',
      confirmTitle: '确认卸载',
      confirmMessage: '确定要卸载 MindOS 吗？这将停止所有服务并移除 CLI。',
      confirmButton: '卸载',
      cancelButton: '取消',
      running: '正在卸载...',
      success: 'MindOS 已卸载。',
      error: '卸载失败，可在终端手动运行 `mindos uninstall`。',
      kbSafe: '你的知识库文件是安全的——此操作不会删除它们。',
    },
  },
  onboarding: {
