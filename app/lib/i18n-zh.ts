...
export const zh = {
  ...
  agentsContent: {
    ...
    workspacePulse: {
      ...
      enabledSkills: '已启用技能',
      healthy: '健康',
      needsAttention: (n: number) => `${n} 个问题待处理`,
    },
    navOverview: '总览',
    navMcp: 'MCP',
    navSkills: 'Skills',
    ...
    overview: {
      ...
      nextAction: '下一步动作',
      nextActionHint: '先处理已检测待配置的 Agent MCP 重连，再启用必需技能。',
      riskLevelError: '错误',
      riskLevelWarn: '警告',
      na: '暂无',
    },
    mcp: {
      ...
      crossAgentServersTitle: '全部已配置 MCP Servers（跨 Agent）',
      crossAgentServersEmpty: '未在任何 Agent 中检测到 MCP server 配置。',
    ...
    skills: {
      ...
      crossAgentSkillsTitle: '全部已安装 Skills（跨 Agent）',
      crossAgentSkillsEmpty: '未在任何 Agent 工作目录中检测到已安装技能。',
    ...
    detail: {
      ...
      nativeInstalledSkills: 'Agent 原生已安装 Skills（工作目录）',
      nativeInstalledSkillsCount: (n: number) => `检测到技能：${n}`,
      nativeInstalledSkillsEmpty: '该 Agent 工作目录下未检测到已安装技能。',
      nativeInstalledSkillsMore: (n: number) => `另有 ${n} 个`,
      configuredMcpServers: 'Agent 已配置 MCP Servers（配置文件）',
      configuredMcpServersCount: (n: number) => `检测到 servers：${n}`,
      configuredMcpServersEmpty: '该 Agent 暂未配置任何 MCP server。',
