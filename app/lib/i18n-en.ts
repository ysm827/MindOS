export const en = {
  ...
  agentsContent: {
    ...
    workspacePulse: {
      ...
      healthy: 'Healthy',
      needsAttention: (n: number) => `${n} issue(s) need attention`,
    },
    navOverview: 'Overview',
    navMcp: 'MCP',
    navSkills: 'Skills',
    ...
    overview: {
      ...
      nextActionHint: 'Prioritize MCP reconnect for detected agents, then enable required skills.',
    ...
    mcp: {
      ...
      crossAgentServersTitle: 'All configured MCP servers (across agents)',
      crossAgentServersEmpty: 'No MCP servers detected across any agent.',
      crossAgentServerAgents: (names: string) => `Used by: ${names}`,
      configVisibilityTitle: 'Config visibility',
      hiddenRootDetected: (n: number, total: number) => `Hidden root detected: ${n}/${total}`,
      runtimeSignalDetected: (n: number, total: number) => `Runtime signals detected: ${n}/${total}`,
      ...
      bulkReconnectFiltered: 'Reconnect filtered',
    ...
    skills: {
      title: 'Skills',
      summaryTitle: 'Skill status summary',
      summaryEnabled: (n: number) => `Enabled: ${n}`,
      summaryDisabled: (n: number) => `Disabled: ${n}`,
      summaryAttention: (n: number) => `Needs attention: ${n}`,
      crossAgentSkillsTitle: 'All installed skills (across agents)',
      crossAgentSkillsEmpty: 'No skills detected across any agent workspace.',
      crossAgentSkillAgents: (names: string) => `Installed in: ${names}`,
      capabilityGroups: 'Capability groups',
      registrySummaryTitle: 'Agent skill registry',
      registryUniversal: (n: number) => `Universal mode: ${n}`,
      registryAdditional: (n: number) => `Additional mode: ${n}`,
      registryUnsupported: (n: number) => `Unsupported mode: ${n}`,
      registryHiddenRoots: (n: number, total: number) => `Hidden roots detected: ${n}/${total}`,
      tabs: {
        manage: 'Manage',
        matrix: 'Matrix',
      },
      ...
      bulkEnableFiltered: 'Enable filtered',
      bulkDisableFiltered: 'Disable filtered',
    ...
    detail: {
      ...
      runtimeSignals: 'Runtime and Config Signals',
      ...
      hiddenRootPresent: 'Hidden root detected',
      conversationSignal: 'Conversation signal',
      ...
      nativeInstalledSkills: 'Native installed skills (agent workspace)',
      nativeInstalledSkillsCount: (n: number) => `Detected skills: ${n}`,
      nativeInstalledSkillsEmpty: 'No installed skills detected in this agent workspace.',
      nativeInstalledSkillsMore: (n: number) => `+${n} more`,
      configuredMcpServers: 'Configured MCP servers (agent config)',
      configuredMcpServersCount: (n: number) => `Detected servers: ${n}`,
      configuredMcpServersEmpty: 'No MCP servers configured for this agent yet.',
