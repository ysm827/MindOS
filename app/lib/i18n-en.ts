export const en = {
  ...
  settings: {
    ...
    uninstall: {
      ...
      desc: 'Remove MindOS CLI, background services, and configuration files from this machine.',
      warning: 'This will stop all running services and remove MindOS. Your knowledge base files will not be deleted unless you choose to.',
      stopServices: 'Stop Services',
      stopServicesDesc: 'Stop all running MindOS processes and background daemons.',
      ...
      confirmMessage: 'Are you sure you want to uninstall MindOS? This will stop all services and remove the CLI.',
      ...
      kbSafe: 'Your knowledge base files are safe — they are not deleted by this action.',
    },
  },
  onboarding: {
