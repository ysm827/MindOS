...
export const settingsEn = {
  settings: {
    ...
    mcp: {
      ...
      connectionHint: 'Use these credentials to connect AI agents to your MindOS knowledge base.',
...
export const settingsZh = {
  settings: {
    title: '设置',
    tabs: { ai: 'AI', appearance: '外观', knowledge: '通用', sync: '同步', mcp: 'MCP 与技能', plugins: '插件', shortcuts: '快捷键', monitoring: '监控', agents: '智能体', update: '更新', uninstall: '卸载' },
    ai: {
      provider: '服务商',
      model: '模型',
      apiKey: 'API 密钥',
    ...
    mcp: {
      ...
      connectionHint: '使用以下凭据将 AI 助手连接到你的 MindOS 知识库。',
      tokenLabel: '认证令牌',
