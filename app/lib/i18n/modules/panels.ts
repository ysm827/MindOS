...
export const panelsEn = {
  ...
  echoPages: {
    ...
    snapshotSelfTitle: 'Clues gather here',
    snapshotSelfBody:
    ...
    dailyAskPrefill: (line: string) =>
      `Echo / Imprint — reflect on this line:\n\n${line.trim() || '(empty line)'}`,
    ...
    imprintLead: 'One line. No pressure. Chat when you want depth.',
    growthLead: 'The direction you are pushing — and how it drifts.',
    selfLead: 'Notes and links that point back to you — surfaced, not searched.',
  },
  agentsContent: {
    title: 'Agents',
...
export const panelsZh = {
  ...
  echoPages: {
    ...
    snapshotSelfTitle: '线索在此汇聚',
    snapshotSelfBody:
      '路径、链接或标题指向你的笔记会浮现在这里，点击即可打开编辑。也可以用下方按钮聊聊。',
    insightTitle: '见解',
    insightShow: '展开见解',
    insightHide: '收起见解',
    insightHint:
    ...
    imprintLead: '一行就够。想展开时再找 Agent。',
    growthLead: '你正在推进的方向，以及它如何缓慢漂移。',
    selfLead: '无需翻找，与你相关的笔记自然浮现。',
  },
  agentsContent: {
    title: '智能体',
